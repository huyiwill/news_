...
class CatenewsModel extends Model{
    ...
    public function getCateNewsByRand($limit){
        $news1 = M('news_cate')->where(array('news_cate'=>'jrnc'))->order('id desc')->limit($limit)->select();
        $news2 = M('news_cate')->where(array('news_cate'=>'ncsp'))->order('id desc')->limit($limit)->select();
        $news3 = M('news_cate')->where(array('news_cate'=>'szxw'))->order('id desc')->limit($limit)->select();
        $news4 = M('news_cate')->where(array('news_cate'=>'gnxw'))->order('id desc')->limit($limit)->select();
